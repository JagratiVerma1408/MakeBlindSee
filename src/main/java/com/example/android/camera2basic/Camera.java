...
import com.example.android.camera2basic.tflite.Classifier;
...
public abstract class Camera extends AppCompatActivity
  ...
  @Override
  public void onPreviewFrame(final byte[] bytes, final android.hardware.Camera camera) {
          ...
          CameraConnectionFragment.newInstance(
              new CameraConnectionFragment.ConnectionCallback() {
                ...
                public void onPreviewSizeChosen(final Size size, final int rotation) {
                  ...
                  Camera.this.onPreviewSizeChosen(size, rotation);
                }
              },
              this,
              getLayoutId(),
